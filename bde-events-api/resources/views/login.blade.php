    ...
    <div class="max-w-md mx-auto my-10">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Sign in to manage your campus event passes</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center text-xs text-gray-600 cursor-pointer">
                        <input type="checkbox" name="remember" id="remember" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4">
            ...
            <div class="mt-6 text-center border-t border-gray-100 pt-4">
                <p class="text-xs text-gray-600">
                    ...
                    <a href="{{ route('show.register') }}" class="font-semibold text-indigo-600 hover:underline">
                        Create one now
                    </a>
                </p>
            </div>
